...
| :--------------: | :------------------------------: |
|  ![](imori.jpg)  | ![](result_image/answer_1.jpg)  |

> 答案：
>
> * Python >> [answers_py/answer_1.py](code_py/BGR2RGB.py)
> * C++ >> [answers_cpp/answer_1.cpp](code_cpp/answer_1.cpp)
...
| :--------------: | :------------------------------: |
|  ![](imori.jpg)  | ![](result_image/answer_2.jpg)  |

> 答案：
>
> * Python >> [answers_py/answer_2.py](code_py/BGR2GRAY1.py)
>
> * C++ >> [answers_cpp/answer_2.cpp](code_cpp/answer_2.cpp)
...
| :--------------: | :------------------------------: |
|  ![](imori.jpg)  | ![](result_image/answer_3.jpg)  |

> 答案 
>
> * Python >> [answers_py/answer_3.py](code_py/BGR2GRAY2.py)
> * C++ >> [answers_cpp/answer_3.cpp](code_cpp/answer_3.cpp)
...
| :--------------: | :----------------------------------------------------: |
|  ![](imori.jpg)  |            ![](result_image/answer_4.jpg)             |

> 答案
> Python >> [answers/answer_4.py](answers/answer_4.py)
> C++ >> [answers_cpp/answer_4.py](code_cpp/answer_4.py)
...
| :--------------: | :------------------------------: |
|  ![](imori.jpg)  | ![](result_image/answer_5.jpg)  |

> 答案 
>
> * Python >> [answers_py/answer_5.py](code_py/BGR2HSV.py)
> * C++ >> [answers_cpp/answer_5.cpp](code_cpp/answer_5.cpp)
...
| :--------------: | :------------------------------: |
|  ![](imori.jpg)  | ![](result_image/answer_6.jpg)  |

> 答案 
>
> * Python >> [answers_py/answer_6.py](code_py/dicrease_color.py)
> * C++ >> [answers_cpp/answer_6.cpp](code_cpp/answer_6.cpp)
...
| :--------------: | :------------------------------: |
|  ![](imori.jpg)  | ![](result_image/answer_7.jpg)  |

> 答案 
>
> * Python >> [answers_py/answer_7.py](code_py/average_pooling.py)
> * C++ >> [answers_cpp/answer_7.cpp](code_cpp/answer_7.cpp)
...
| :--------------: | :------------------------------: |
|  ![](imori.jpg)  | ![](result_image/answer_8.jpg)  |

> 答案
> - Python >> [answers_py/answer_8.py](code_py/max_pooling.py)
> - C++ >> [answers_cpp/answer_8.cpp](code_cpp/answer_8.cpp)
...
| :--------------------: | :------------------------------: |
|  ![](imori_noise.jpg)  | ![](result_image/answer_9.jpg)  |

> 答案 
>
> * Python >> [answers_py/answer_9.py](code_py/gaussian_filter.py)
> * C++ >> [answers_cpp/answer_9.cpp](code_cpp/answer_9.cpp)
...
| :--------------------: | :-------------------------------: |
|  ![](imori_noise.jpg)  | ![](result_image/answer_10.jpg)  |

> 答案 
>
> * Python >> [answers_py/answer_10.py](code_py/median_filter.py)
> * C++ >> [answers_cpp/answer_10.cpp](code_cpp/answer_10.cpp)